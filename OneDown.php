<?php
   function OneDown($filelocation, $savingLocation)
   {
       $dom = new DOMDocument();
      ...
      $notes = $xpath->query('//note/pitch');
	   ...
	   foreach($basses as $bass){
       	 	...
       	 	$bass_steps = $bass->getElementsByTagName('bass-step');
       	 	$bass_alter = $bass->getElementsByTagName('bass-alter');
   
     	 	if($bass_steps->item(0)->nodeValue == 'C' && $bass_alter->item(0)){
		       if($bass_steps->item(0)->nodeValue == 'C' && $bass_alter->item(0)->nodeValue =='1'){
		       		$bass_steps->item(0)->nodeValue = 'B';
		       		$bass_alter->item(0)->nodeValue = '0';
		       }
		       else if($bass_steps->item(0)->nodeValue == 'C' && $bass_alter->item(0)->nodeValue == '-1'){
		       		$bass_steps->item(0)->nodeValue = 'A';
		       		$bass_alter->item(0)->nodeValue = '0';
		       }
		    }
	       else if($bass_steps->item(0)->nodeValue == 'C' && !($bass_alter->item(0))){
	       		$bass_steps->item(0)->nodeValue = 'B';
	       ...
	       else if($bass_steps->item(0)->nodeValue == 'D' && $bass_alter->item(0)){	       
		       if($bass_steps->item(0)->nodeValue == 'D' && $bass_alter->item(0)->nodeValue == '1'){
		       		$bass_steps->item(0)->nodeValue = 'C';
		       		$bass_alter->item(0)->nodeValue = '1';
		       }
		       else if($bass_steps->item(0)->nodeValue == 'D' && $bass_alter->item(0)->nodeValue == '-1'){
		       		$bass_steps->item(0)->nodeValue = 'B';
		       		$bass_alter->item(0)->nodeValue = '0';
		       }
		    }
       	 	...
       	 	else if($bass_steps->item(0)->nodeValue == 'E' && $bass_alter->item(0)){
		       if($bass_steps->item(0)->nodeValue == 'E' && $bass_alter->item(0)->nodeValue == '-1'){
		       		$bass_steps->item(0)->nodeValue = 'D';
		       		$bass_alter->item(0)->nodeValue = '-1';
		       }
		       else if($bass_steps->item(0)->nodeValue == 'E' && $bass_alter->item(0)->nodeValue == '1'){
		       		$bass_steps->item(0)->nodeValue = 'E';
		       		$bass_alter->item(0)->nodeValue = '-1';
		       }
		    }
	       else if($bass_steps->item(0)->nodeValue == 'E' && !($bass_alter->item(0))){
       	 	...
       	 	else if($bass_steps->item(0)->nodeValue == 'F' && $bass_alter->item(0)){
		       if($bass_steps->item(0)->nodeValue == 'F' && $bass_alter->item(0)->nodeValue == '-1'){
		       		$bass_steps->item(0)->nodeValue = 'D';
		       		$bass_alter->item(0)->nodeValue = '0';
		       }
		       else if($bass_steps->item(0)->nodeValue == 'F' && $bass_alter->item(0)->nodeValue == '1'){
		       		$bass_steps->item(0)->nodeValue = 'E';
		       		$bass_alter->item(0)->nodeValue = '0';
		       }
		    }
       	 	...
       	 	else if($bass_steps->item(0)->nodeValue == 'G' && $bass_alter->item(0)){	       
		       if($bass_steps->item(0)->nodeValue == 'G' && $bass_alter->item(0)->nodeValue == '-1'){
		       		$bass_steps->item(0)->nodeValue = 'E';
		       		$bass_alter->item(0)->nodeValue = '0';
		       }
		       else if($bass_steps->item(0)->nodeValue == 'G' && $bass_alter->item(0)->nodeValue == '1'){
		       		$bass_steps->item(0)->nodeValue = 'F';
		       		$bass_alter->item(0)->nodeValue = '1';
		       }
		    }
	       else if($bass_steps->item(0)->nodeValue == 'G' && !($bass_alter->item(0))){
       	 	...
       	 	else if($bass_steps->item(0)->nodeValue == 'A' && $bass_alter->item(0)){
		       if($bass_steps->item(0)->nodeValue == 'A' && $bass_alter->item(0)->nodeValue == '-1'){
		       		$bass_steps->item(0)->nodeValue = 'F';
		       		$bass_alter->item(0)->nodeValue = '1';
		       }
		       else if($bass_steps->item(0)->nodeValue == 'A' && $bass_alter->item(0)->nodeValue == '1'){
		       		$bass_steps->item(0)->nodeValue = 'A';
		       		$bass_alter->item(0)->nodeValue = '-1';
		       }
		    }
	       else if($bass_steps->item(0)->nodeValue == 'A' && !($bass_alter->item(0))){
	       		$bass_steps->item(0)->nodeValue = 'G';
       	 	...
       	 	else if($bass_steps->item(0)->nodeValue == 'B' &&  $bass_alter->item(0)){	       
		       if($bass_steps->item(0)->nodeValue == 'B' && $bass_alter->item(0)->nodeValue == '-1'){
		       		$bass_steps->item(0)->nodeValue = 'A';
		       		$bass_alter->item(0)->nodeValue = '-1';
		       }
		       else if($bass_steps->item(0)->nodeValue == 'B' && $bass_alter->item(0)->nodeValue == '1'){
		       		$bass_steps->item(0)->nodeValue = 'B';
		       		$bass_alter->item(0)->nodeValue = '-1';
