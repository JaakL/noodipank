<?php
   function keyChangeHalfUp()
   {
       $dom = new DOMDocument();
       $dom->load('TulbidTransposed.xml');  	// 	See koht tuleb ära muuta nii, et võtaks Laikre poolt üles laetud ja kliendi poolt valitud laulu XML'i. Hetkel lihtsalt testimiseks üks fail.
